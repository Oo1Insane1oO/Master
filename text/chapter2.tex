...
\section{Quantum Monte Carlo}
    ...
    \subsection{Use Diffusion Theory and the PDF\label{susec:diffTHpdf}}
        ...
        the Langevin equation with the corresponding Focker-Planck equation
    ...
    \subsection{Importance Sampling\label{susec:impSamp}}
        ...
        Metropolis algorithm is called an importance sampling because is
        essentially makes the sampling more concentrated around areas where the
        PDF has large values. \\
