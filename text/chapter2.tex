...
\chapter{Many-Body Quantum Theory\label{chapter:2}}
    ...
    equation for a many-body system. Many methods have been devised and we will
    in this chapter take forth the theory regarding the basics of identical
    ...
    throughout the entire chapter. We will address methods regarding
    computational quantum mechanics and further deepen into Hartree-Fock
    methods and Variational Monte Carlo method. 
...
\section{Density Matrices}
    ...
    tells us that the element
        ...
        \end{equation}
    with $P$ denoting a probability. This might not give any tingles first-hand
