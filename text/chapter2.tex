...
\subsection{Hartree-Fock Limit}
    ...
    we have the following names for the different quantities involved
        \begin{itemize}
            \item Hartree-Fock energy:\indent\indent Obtained energy
            \item Hartree-Fock orbitals:\indent\indent Basisfunction, \Arf{eq:HFexpansiondephi}
            \item Hartree-Fock wavefunction:\indent\indent Slater determinant of the orbitals 
        \end{itemize}
