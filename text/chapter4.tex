...
\section{Gradient Descent\label{sec:gradient_descent}}
    ...
    Here are two figures of the functions
        ...
        sphere function with minimum at $\blds{x}_m=(0,0)$ with value
        $f(\blds{x}_m)=0$.}{fig:sf}
        \onefigure{Rosenbrock Function}{text/figs/rosenbrock.pdf}{Illustration
        of Rosenbrock function with minimum at $\blds{x}_m=(1,1)$ with value
        $f(\blds{x}_m)=0$.}{fig:rb}
    ...
    As for the convergence we give a table with number of iterations.
        \begin{table}[H]
            ...
            \begin{tabular}{ccccc} \hline\hline
                ...
                $(5,5)$ & $0.1$ & $100$ & $(1.273\times10^{-9},1.273\times10^{-9})$ & $3.242\times10^{-18}$
            \end{tabular}
        ...
        \begin{table}[H]
            ...
            \begin{tabular}{ccccc} \hline\hline
                ...
                $(0,0.5)$ & $0.0001$ & $100000$ & $(0.994,0.989)$ & $3.131\times10^{-5}$
            \end{tabular}
            \caption{Table showing convergence of the gradient descent method
