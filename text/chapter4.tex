...
\section{Gradient Descent\label{sec:gradient_descent}}
    ...
    Here are two figures of the functions
        ...
        sphere function\cite{simulationlib} with minimum at $\blds{x}_m=(0,0)$
        with value $f(\blds{x}_m)=0$.}{fig:sf}
        \onefigure{Rosenbrock Function}{text/figs/rosenbrock.pdf}{Illustration
        of Rosenbrock function\cite{simulationlib} with minimum at
        $\blds{x}_m=(1,1)$ with value $f(\blds{x}_m)=0$.}{fig:rb}
%         \twofigure{text/figs/sphere.pdf}{Illustration of sphere
%         function}{subfig:sf}{text/figs/rosenbrock.pdf}{Illustration of
%         Rosenbrock function}{subfig:sf}{Test-Functions}
...
\section{Simulated Annealing\label{sec:simulated_annealing}}
    ...
    local minima. Two such functions are the \txtit{Ackley function} and the
    \txtit{Rastrigin function}, figures are shown below
        \onefigure{Ackley Function}{text/figs/ackley.pdf}{Illustration of
        Ackley function\cite{simulationlib} with global minimum at
        $\blds{x}_m=(0,0)$ with value $f(\blds{x}_m)=0$.}{fig:ack}
        \onefigure{Rastrigin Function}{text/figs/rastrigin.pdf}{Illustration of
        Rastrigin function\cite{simulationlib} with global minimum at
        $\blds{x}_m=(0,0)$ with value $f(\blds{x}_m)=0$.}{fig:rastr}
