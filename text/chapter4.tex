...
\section{Integral Elements}
    ...
    simpler integral over a so-called \txtit{one-electron distribution}
        \begin{equation}
    ...
    rewrite the inverse term with
        ...
        \end{equation}
    The one-electron integral is thus, with \Arf{eq:gaussianProductRule}(again
    the product rule)
        \begin{align}
    ...
    giving
        ...
        \end{align}
    This integral must be solved numerically. One can also rewrite this in terms of the \txtit{Modified Bessel function of first kind} by using $u^2=1/2(1 - \cos(\theta)$.
