...
\subsection{Coulomb Potential Integral}
    ...
    giving
        \begin{align}
            I_{\text{2D}} = \frac{\sqrt{\pi}}{\alpha}\int\limits^1_{-1}
    ...
    the same substitution)
        \begin{align}
            I_{\text{3D}} = \frac{\pi}{\alpha}\int\limits^1_{-1} \me^{-\alpha
...
\subsection{Coulomb Interaction Integral}
    ...
    we have
        \begin{align}
            I' &= \frac{1}{\alpha}\infint \int\limits^1_{-1} \upsilon
    ...
    we have
        \begin{equation}
            I'_{\text{2D}} =
            \frac{\pi^{\frac{3}{2}}}{\alpha\sqrt{\beta(\alpha+\beta)}}
...
\subsection{Coulomb Distribution Integral}
    ...
    simplification in \Arf{eq:centerDerGauss} gives(still in two dimensions)
        \begin{align}
            ...
            &= \prtl^{ijkl}_{ABCD}\sqrt{\pi} \infint
            I_{2D}(\alpha+\gamma,\abs{\blds{r_2}- \blds{S}}) K_{BD}
            \me^{-(\beta + \delta)r^2_2} \md\blds{r_2} \nonumber \\
            &= \pi^{\frac{3}{2}} \prtl^{ijkl}_{ABCD}
            I'_{2D}\left(\alpha+\gamma,\beta+\delta,\abs{\blds{S}-\blds{P}}\right)
            \nonumber \\
            &= \frac{\pi^{\frac{3}{2}}}{(\alpha + \gamma)\sqrt{(\beta +
            \delta)(\alpha+\gamma+\beta+\delta)}} \prtl^{ijkl}_{ABCD}
            \zeta_0\left(\frac{1}{\alpha+\gamma+\beta+\delta}\abs{\blds{S} -
            \blds{P}}^2\right)
%             &= \prtl^{ijkl}_{ABCD} \frac{1}{\sqrt{\pi}}\infint\infint\infint
