...
\section{Gradient Descent\label{sec:gradient_descent}}
    ...
    applied to two test-functions. One simple sphere-function and the
    Rosenbrock function. Here are two figures of the functions
        \onefigure{Sphere Function}{text/figs/sphere.pdf}{Illustration of
        sphere function}{fig:sf}
        \onefigure{Rosenbrock Function}{text/figs/rosenbrock.pdf}{Illustration
        of Rosenbrock function}{fig:sf}
...
%                 $\blds{x}_0$ & $\gamma$ & Iterations & $\blds{x}_m$ & $f(\blds{x}_m)$
%             \end{tabular}
            \caption{Table showing convergence of the gradient descent scheme.}
        \end{table}
