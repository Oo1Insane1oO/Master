...
\section{Gaussian Type Orbitals}
    \txtit{Gaussian Type Orbitals} or GTO's are functions of form
...
\subsection{Overlap Distribution}
    ...
    recurrence) and the expansion in \Arf{eq:omegaDef}. The incrementation of
    ...
    $E$'s given in \Arf{eq:coupledreccoeff}.
        \begin{equation}
            \begin{aligned}
...
\subsection{Potential Integral}
    ...
    Gaussian product rule) given in \Arf{eq:potIntegral}.
        \begin{align}
...
\subsection{Recurrence Relation\label{sub:445}}
    ...
    will write it out in \Arf{eq:recurrInteraction} for the sake of clarity.
        \begin{equation}
            \begin{aligned}
...
\subsection{Choosing the Basis Functions}
    ...
    means that we choose the basis functions according to the \txtit{magic
    ...
    the magic-number in mind), \Arf{eq:Heigdef}, the eignvalues will converge.
    ...
    \Arf{tab:eig2D}. See also \Arf{sec:dwbimp} for more on the specific
    implementation.
