...
\section{Hartree-Fock Theory\label{sec:HFtheory}}
    ...
    \cite{HelgakerMolElcTheory}. This approach is not generally feasable as the
    size of the system increases, however for a closed-shell system in the
    ...
    \subsection{Metropolis-Hastings Algorithm\label{susec:MHAlg}}
        ...
        \begin{figure}[H]
            ...
            \begin{tikzpicture}[
                ...
                \node (a) [activityRuns, below left of=3, xshift=-3cm] {
                    Accepted \\
                    $j = i$
                };
                \node (r) [startstop, below right of=3, xshift=3cm] {
                    Rejected \\
                    $i = j$
                };
                ...
                \draw[->] (yes) -- (5);
            \end{tikzpicture}
            \caption{Flow chart of the Metropolis algorithm.}
        \end{figure}
