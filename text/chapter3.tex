...
\section{Quantum Monte Carlo\label{sec:QMC}}
    ...
    \subsection{Importance Sampling\label{susec:impSamp}}
        ...
        \Arf{eq:diffeqFP} >>REF THIS<<, the equation is transformed to
            \begin{equation}
        ...
        express this with a \txtit{Dirac-delta function}>>REF THIS<< giving
            \begin{equation}
    ...
    \subsection{The Trial Wavefunction: One-Body}
        ...
        expressed as a \txtit{Slater determinant} >> REF SLATER <<for the
    ...
    \subsubsection{The Trial Wavefunction: Pad\'e
        ...
        \txtit{Pad\'e-Jastrow} function. It is defined as\cite{basicMB} >> REF
        MORE <<
            \begin{equation}
        ...
        so-called \txtit{cusp condition} which cancels the divergency of the
