        ...
        \begin{figure}[H]
            ...
            \begin{tikzpicture}[
                    >={Latex[width=2mm,length=2mm]},
                        ...
                        startstopcode/.style = {basecode, fill=red!30, drop shadow},
                ...
                \node (a) [activityRuns, below left of=3, xshift=-2cm] {
                    Accepted \\
                    $j = i$
                };
                \node (r) [startstop, below right of=3, xshift=2cm] {
                    Rejected \\
                    $i = j$
                };
                ...
                \node (no) [above left of=4, xshift=-4cm] {
                    No
                };
