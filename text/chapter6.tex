    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}[
            ...
            \node (finalsample) [activityStarts, below of=minimize] {
                Run final sampling with optimal parameters.
            };
...
\section{Minimization}
    ...
    \hltexttt{ImportanceSampling}) and \hltexttt{vmc} is the object with said
    type initializes. The \hltexttt{Minimize} function is the function which
    ...
    \Arf{fig:minimizeProc}.
        \begin{figure}[H]
            ...
            \end{tikzpicture}
            \caption{Flow chart of procedure done by \hltexttt{minimize}
